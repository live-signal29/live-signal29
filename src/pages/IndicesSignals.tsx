        ...
        <div className="container mx-auto px-4 py-12">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">
              <span className="gradient-text">Indices Signals</span>
            </h1>
            <p className="text-muted-foreground">US30, NASDAQ, S&P500 trading signals</p>
          </div>
