    ...
    <div className="min-h-screen bg-[#0b0f19] text-slate-100 flex items-center justify-center p-4 font-sans">
      ...
      <div className="w-full max-w-md bg-[#131926] border border-slate-800/80 rounded-2xl p-6 shadow-2xl relative">
        ...
        <div className="grid grid-cols-2 bg-[#0b0f19] p-1 rounded-xl mb-6 border border-slate-800">
          ...
          <button
            type="button"
            className="py-2.5 text-xs font-bold rounded-lg bg-blue-600 text-white shadow-md"
          >
            Log In
          </button>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              required
              autoComplete="email"
              className="w-full h-12 bg-[#0b0f19] border border-slate-800 focus:border-blue-500 focus-visible:ring-0 text-white text-sm rounded-xl px-4 outline-none transition placeholder:text-slate-600"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="w-full h-12 bg-[#0b0f19] border border-slate-800 focus:border-blue-500 focus-visible:ring-0 text-white text-sm rounded-xl px-4 pr-11 outline-none transition placeholder:text-slate-600"
              />
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full h-12 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl text-sm transition duration-200 shadow-lg shadow-blue-600/20 mt-2"
          >
