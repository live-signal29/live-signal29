        ...
        <div className="container mx-auto px-4 py-12">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">
              <span className="gradient-text">Commodities Signals</span>
            </h1>
            <p className="text-muted-foreground">Gold (XAUUSD), Silver, Oil trading signals</p>
          </div>
...
export default CommoditiesSignals;