...
// Plain "Broker — Server" text, used in the "Broker: ..." lines.
const brokerPlain = (s: PublicCopierStat) => {
  if (!s.broker_name) return "Not specified";
  return s.broker_server ? `${s.broker_name} — ${s.broker_server}` : s.broker_name;
};

// "MT5 • Broker — Server" label, used wherever the card shows the MT5 tag.
