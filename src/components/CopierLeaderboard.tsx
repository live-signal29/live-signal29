        ...
        <div className="mt-4 space-y-2.5">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-border/50 bg-background/60 p-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-[10px] sm:text-[11px] leading-relaxed text-muted-foreground">
                ...
                is required to use our copy trading service.
              </p>
          ...
          <div className="flex items-start gap-3 rounded-xl border border-border/50 bg-background/60 p-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-[10px] sm:text-[11px] leading-relaxed text-muted-foreground">
                <span className="font-semibold text-foreground">
                  50% of generated profits
                </span>{" "}
                will be shared with our team. The remaining 50% belongs to you.
              </p>
        ...
        >
          ...
          {visibleStats.map((s) => {
            ...
            const rejectedMessage =
              `Hello, my name is ${s.name || "Copier User"}. ` +
              `I submitted an MT5 Copier connection request which was rejected. ` +
              `Could you please let me know the reason? Thank you.`;
