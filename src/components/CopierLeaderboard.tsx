...
export const CopierLeaderboard = () => {
  ...
  return (
    <div className="pb-24">
      ...
      {/* =========================================================
          NEW MATCHED HERO BANNER (FROM IMAGE DESIGN)
          ========================================================= */}
      <div className="relative mb-4 overflow-hidden rounded-[24px] bg-gradient-to-br from-[#061c12] to-[#020d07] p-6 sm:p-8 shadow-[0_20px_40px_rgba(0,0,0,0.5),0_0_30px_rgba(0,255,136,0.1)] border border-[#00ff88]/20 text-white">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 w-full">
            ...
            {/* Top Badge */}
            <div className="inline-flex items-center gap-2 bg-[#00ff88]/10 border border-[#00ff88]/30 text-[#00ff88] px-4 py-2 rounded-full font-semibold text-sm mb-6">
            ...
            {/* Description */}
            <p className="text-[#b0c4b8] text-base sm:text-lg mb-6 max-w-lg leading-relaxed">
            ...
            <div className="flex items-center gap-4 mb-8 text-sm font-medium">
              <div className="flex items-center gap-2"><span>⚡</span> Auto Copy</div>
              <div className="w-px h-4 bg-[#00ff88]/30"></div>
              <div className="flex items-center gap-2"><span>🛡️</span> Secure</div>
              <div className="w-px h-4 bg-[#00ff88]/30"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <div className="bg-[#00140a]/60 border border-[#00ff88]/25 rounded-2xl p-4 flex items-center gap-3">
                <div className="text-2xl text-[#00ff88]">🛡️</div>
                <div>
                  <strong className="block text-sm text-white">REAL ACCOUNT</strong>
                  <span className="text-xs text-[#8da898]">(MT5 / MT4 ONLY)</span>
                </div>
              </div>

              <div className="bg-[#00140a]/60 border border-[#00ff88]/25 rounded-2xl p-4 flex items-center gap-3">
                <div className="text-2xl text-[#00ff88]">📦</div>
                <div>
                  <strong className="block text-sm text-white">$100 MINIMUM</strong>
                  <span className="text-xs text-[#8da898]">UNLIMITED MAXIMUM</span>
                </div>
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#00e676] to-[#00b050] hover:opacity-95 text-[#051a0e] font-bold text-lg py-7 rounded-2xl shadow-[0_10px_20px_rgba(0,230,118,0.3)] transition-all transform hover:-translate-y-0.5 flex items-center justify-between px-6"
            >
              <span className="flex items-center gap-3">
                <Link2 className="h-6 w-6" /> Connect MT5 / MT4
              </span>
          ...
          {/* Right Graphic Section (Phone mockup style matching image) */}
          <div className="relative w-full lg:w-[320px] flex justify-center items-center py-6">
            <div className="relative w-[220px] h-[300px] flex justify-center items-center">
              
              {/* MT5 Floating Badge */}
              <div className="absolute -top-4 -left-6 bg-[#00c853] text-white px-4 py-1.5 rounded-full font-bold text-sm shadow-lg z-30">
                MT5
              </div>

              {/* MT4 Floating Badge */}
              <div className="absolute top-16 -right-6 bg-[#2979ff] text-white px-4 py-1.5 rounded-full font-bold text-sm shadow-lg z-35">
                MT4
              </div>

              {/* Phone Body Mockup */}
              <div className="w-[170px] h-[270px] bg-[#04120a] border-[3px] border-[#00ff88] rounded-[28px] flex flex-col justify-center items-center shadow-[0_0_35px_rgba(0,255,136,0.4)] z-20 relative overflow-hidden">
                <div className="absolute top-3 text-xs font-bold text-[#00ff88] flex items-center gap-1">
                  📈 Live Signals
                </div>
              </div>

              {/* Glowing Ring underneath */}
              <div className="absolute bottom-2 w-[160px] h-[40px] bg-[radial-gradient(ellipse_at_center,rgba(0,255,136,0.8)_0%,rgba(0,0,0,0)_70%)] rounded-full z-10"></div>
